...
export function DashboardGrid({
  ...
  const tiles: Tile[] = [
    ...
    },
    {
      ...
      labelEn: "Services Menu",
      icon: FiPackage,
      metaAr: "الفئات والأسعار",
      metaEn: "Categories & pricing",
      cardClass: "bg-gradient-to-br from-orange-900/35 via-slate-900/70 to-slate-900/70 hover:from-orange-800/40",
    ...
    },
    {
      ...
      labelEn: "Settings",
      icon: FiSliders,
      metaAr: "ويدجت وإعدادات",
      metaEn: "Widgets & config",
      cardClass: "bg-gradient-to-br from-sky-900/35 via-slate-900/70 to-slate-900/70 hover:from-sky-800/40",
    ...
    },
    {
      ...
      labelEn: "Analytics",
      icon: FiBarChart2,
      metaAr: "تقارير ورسوم بيانية",
      metaEn: "Reports & charts",
      cardClass: "bg-gradient-to-br from-pink-900/35 via-slate-900/70 to-slate-900/70 hover:from-pink-800/40",
    ...
    {
      id: "housekeeping",
      href: `/${lang}/housekeeping`,
      labelAr: "التنظيف",
      labelEn: "Housekeeping",
      icon: FiDroplet,
      metaAr: "لوحة المهام",
      metaEn: "Task board",
      cardClass: "bg-gradient-to-br from-lime-900/35 via-slate-900/70 to-slate-900/70 hover:from-lime-800/40",
      iconClass: "bg-lime-500/20 text-lime-300",
    ...
    {
      id: "activity-log",
      href: `/${lang}/activity-log`,
      labelAr: "سجل الأحداث",
      labelEn: "Activity Log",
      icon: FiActivity,
      metaAr: "تايم لاين مباشر",
      metaEn: "Live timeline",
      cardClass: "bg-gradient-to-br from-yellow-900/35 via-slate-900/70 to-slate-900/70 hover:from-yellow-800/40",
    ...
    },
    {
      ...
      metaAr: "رسائل الضيوف",
      metaEn: "Guest messages",
      cardClass: "bg-gradient-to-br from-blue-900/35 via-slate-900/70 to-slate-900/70 hover:from-blue-800/40",
    ...
    },
    {
      ...
      metaAr: "متابعة الشكاوى",
      metaEn: "Track issues",
      cardClass: "bg-gradient-to-br from-red-900/35 via-slate-900/70 to-slate-900/70 hover:from-red-800/40",
    ...
    },
    {
      ...
      labelEn: "Lost & Found",
      icon: FiBox,
      metaAr: "الأغراض المفقودة",
      metaEn: "Lost items",
      cardClass: "bg-gradient-to-br from-stone-800/35 via-slate-900/70 to-slate-900/70 hover:from-stone-700/40",
      iconClass: "bg-stone-500/20 text-stone-300",
    ...
    {
      id: "facilities",
      href: `/${lang}/facilities`,
      labelAr: "المرافق",
      labelEn: "Facilities",
      icon: FiMapPin,
      metaAr: "الحجوزات والمواعيد",
      metaEn: "Bookings & slots",
      cardClass: "bg-gradient-to-br from-green-900/35 via-slate-900/70 to-slate-900/70 hover:from-green-800/40",
    ...
    },
    {
      ...
      labelEn: "Invoices",
      icon: FiDollarSign,
      metaAr: "الفوترة والدفع",
      metaEn: "Billing & payments",
      cardClass: "bg-gradient-to-br from-emerald-900/40 via-slate-900/70 to-slate-900/70 hover:from-emerald-800/45",
